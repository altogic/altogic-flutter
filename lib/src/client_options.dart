...
class ClientOptions extends dart.ClientOptions {
  ...
  /// [signInRedirect].
  ///
  /// If [AltogicState] is used above [MaterialApp] or [WidgetsApp] etc.,
  /// and [AltogicState.navigatorObserver] is used, the [BuildContext] will be
  /// automatically set.
  ///
  /// If [AltogicState] is not used, the [BuildContext] is will be null.
  ClientOptions(
      {super.apiKey,
      super.localStorage,
      super.realtime,
